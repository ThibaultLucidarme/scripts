...
apt-get install -y blender calibre darktable gimp gimp-data-extras gnome-color-manager icc-profiles-free imagemagick inkscape kazam krita perlmagick scribus scribus-template
